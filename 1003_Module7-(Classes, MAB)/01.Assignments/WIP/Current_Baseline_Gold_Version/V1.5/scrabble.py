...
#        valid_words.sort(reverse = True)
        #valid_words.sort(reverse = True, key=lambda i:i[1],reverse=True)
        #print(valid_words)
...
#        print(len(valid_words))
    ...
    ################ with SORT (DEPRECATED) #######################
    # deprecated this version -- used SORTED instead
    
    # valid_words.sort(reverse = True)
    # #
    # print(valid_words)
    # print(type(valid_words))
    #print(valid_words_sorted)
    #final_list_tuples = []
    # for entry in valid_words:
    #     score = entry[0]
    #     word_low = entry[1]
...
#    return final_list_tuples
    ...
    #print(valid_words_sorted)
    #return  valid_words_sorted, len(valid_words)
#    final_list_tuples = []
    # for entry in valid_words_sorted:
    #     score = entry[0]
    #     word_low = entry[1]
    #     final_list_tuples.append(score, word_low)
    # return final_list_tuples, len(valid_words)