...
class Bidder:
    ...
    # import random
    # from collections import Counter
    # import auction_gauravnarasimhan
    ...
    def bid(self, user_id):
        ...
        #     self.bidding_round = auction.auction_round
        
        # self.bidding_round += 1
        # print('bidding round - bidder', self.bidding_round)
    
    ############  STOP BIDDING AFTER NUM_ROUNDS  ######################################################
    ############## bid a token miniscule value beyond allocated rounds ################################
        ...
        if self.bidding_round > self.num_rounds:
            ...
            self.bidding_round = self.bidding_round + 1
            print('bidding round number ', self.bidding_round)
            return self.bid_price
